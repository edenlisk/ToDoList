...
**To Do List** This is the online tool that helps you to manage your daily activities. 
...
```sh
  cd my-folder
  git clone git@github.com:edenlisk/ToDoList.git
```
...
Feel free to check the [issues page](https://github.com/edenlisk/ToDoList/issues).
