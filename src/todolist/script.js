...
function createToDo(toDoValue, index){
    ...
    trash.innerHTML =
        `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 15 15">
    ...
    threeDots.innerHTML =
        `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-three-dots-vertical" viewBox="0 0 15 15">
...
export default function displayToDos(){
    toDoInfo.forEach((task, index) => {
        createToDo(task.description, index);
    })
}
